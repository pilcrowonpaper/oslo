import { serializeCookie, parseCookieHeader } from "./index.js";
...
describe("parseCookieHeader()", () => {
	test("parse cookie header", () => {
		const cookies = parseCookieHeader("message1=hello; message2=bye");
	...
	test("reads empty value", () => {
		const cookies = parseCookieHeader("message1=; message2");
